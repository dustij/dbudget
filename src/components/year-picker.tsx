  ...
  return (
    <div className="flex flex-row items-center justify-center">
      <div className="flex flex-row items-center justify-center">
        ...
        <input
          ref={inputRef}
          className="h-8 w-16 rounded bg-white text-center text-base font-medium text-zinc-900 selection:bg-lime-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-lime-500"
          type="number"
          value={value}
